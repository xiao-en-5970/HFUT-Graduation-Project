...
type Order struct {
	...
	ReceiverLat        *float64       `gorm:"column:receiver_lat" json:"receiver_lat,omitempty"`                                      // 收货地图选点纬度 GCJ-02
	ReceiverLng        *float64       `gorm:"column:receiver_lng" json:"receiver_lng,omitempty"`                                      // 收货地图选点经度 GCJ-02
	SenderAddr         string         `gorm:"column:sender_addr;type:varchar(512)" json:"sender_addr"`                                // 发货文字地址
	SenderLat          *float64       `gorm:"column:sender_lat" json:"sender_lat,omitempty"`                                          // 发货地图选点纬度 GCJ-02
	SenderLng          *float64       `gorm:"column:sender_lng" json:"sender_lng,omitempty"`                                          // 发货地图选点经度 GCJ-02

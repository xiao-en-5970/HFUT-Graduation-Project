...
type Order struct {
	...
	ReceiverUserLocationID *uint    `gorm:"column:receiver_user_location_id;index" json:"receiver_user_location_id,omitempty"` // 下单选用的买方地址簿 id
	ReceiverAddr           string   `gorm:"column:receiver_addr;type:varchar(512)" json:"receiver_addr"`                       // 收货文字地址（来自地址簿快照）
	...
	// 买方申请修改收货地，待卖方确认前暂存（与正式 receiver_* 独立）
	PendingReceiverUserLocationID *uint          `gorm:"column:pending_receiver_user_location_id;index" json:"pending_receiver_user_location_id,omitempty"`
	PendingReceiverAddr           string         `gorm:"column:pending_receiver_addr;type:varchar(512)" json:"pending_receiver_addr"`
	PendingReceiverLat            *float64       `gorm:"column:pending_receiver_lat" json:"pending_receiver_lat,omitempty"`
	PendingReceiverLng            *float64       `gorm:"column:pending_receiver_lng" json:"pending_receiver_lng,omitempty"`
